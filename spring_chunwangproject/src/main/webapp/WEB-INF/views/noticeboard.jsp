...
<%
	...
	if(session.getAttribute("userID") != null) {
		...
		admincheck = new UserDAOImpl().getAdminCheck(userID);
	}
...
%>
				<tr>
					...
					<td><a href="contentView?boardType=<%=filename%>&idx=<%=content.getwriteID()%>"><%=content.getTopicName()%></a></td>
<%
		  	...
		  	<ul class="pagination" style="margin: 0 auto;">
				<%
					int startPage = (pageNumber / 10) * 10 + 1;
							...
							if(startPage != 1) {
				%>
				<li class="page-item"><a class="page-link" href="noticeboard?pageNumber=<%= startPage - 1 %>">&lt;</a></li>
		    	<% 
					} else {
				%>
				...
				%>
			    <li class="page-item"><a class="page-link" href="noticeboard?pageNumber=<%= i %>"><%= i %></a></li>
			    <%
					}
			    %>
			    <li class="page-item active"><a class="page-link" href="noticeboard?pageNumber=<%= pageNumber %>"><%= pageNumber %></a></li>
			    <%
			    ...
			    %>
			    <li class="page-item"><a class="page-link" href="noticeboard?pageNumber=<%= startPage + 10 %>">&gt;</a></li>
			    <%
			    }
			    %>
			</ul>
