	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar">
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item">
					<a class="nav-link active bold" style="font-weight: bold; border-bottom: solid 2px #343A40;" href="freeboard">자유광장</a>
				</li>
				<li class="nav-item">
		  	...
		  	<ul class="pagination" style="margin: 0 auto;">
				<%
					int startPage = (pageNumber / 10) * 10 + 1;
							...
							if(startPage != 1) {
				%>
				<li class="page-item"><a class="page-link" href="freeboard?pageNumber=<%= startPage - 1 %>">&lt;</a></li>
		    	<% 
					} else {
				%>
				...
				%>
			    <li class="page-item"><a class="page-link" href="freeboard?pageNumber=<%= i %>"><%= i %></a></li>
			    <%
					}
			    %>
			    <li class="page-item active"><a class="page-link" href="freeboard?pageNumber=<%= pageNumber %>"><%= pageNumber %></a></li>
			    <%
			    ...
			    %>
			    <li class="page-item"><a class="page-link" href="freeboard?pageNumber=<%= startPage + 10 %>">&gt;</a></li>
			    <%
			    }
			    %>
			</ul>
